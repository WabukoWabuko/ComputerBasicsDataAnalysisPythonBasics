...
1. Open `index.html` in your browser for the curriculum overview.
2. To run a local server (recommended for linked assets):
...
Contributing:
- Send improvements or lesson plans by emailing basilwabbs@gmail.com.
